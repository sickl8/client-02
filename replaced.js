...
(function () {
	console.clear();
	console.log('loaded replaced.js!');
    ...
    function _0xFF9E() {
        ...
        _0x11527.prototype.sendOptions = function () {
            ...
            // _0xFF54.setUint16(1, 1000, true);
            // _0xFF54.setUint16(1, -1, true);
            // _0xFF54.setUint16(1, 0, true);
            return _0xFF2F
        };
        ...
        function _0x1128D() {
            ...
            $("#viewDistance").on("change", function () {
                ...
                _0x11493.rViewDistance = Math.min(Math.max(_0xFF2F, 0), 65000);
